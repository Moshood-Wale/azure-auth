...
SOCIAL_AUTH_AZUREAD_OAUTH2_REDIRECT_URI = 'http://localhost:8000/complete/azuread-oauth2/'
SOCIAL_AUTH_AZUREAD_OAUTH2_AUTH_EXTRA_ARGUMENTS = {'response_mode': 'form_post'}
